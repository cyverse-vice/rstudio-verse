...
```
docker pull cyversevice/rstudio-verse:3.6.3
```

```
docker run -it --rm -v /$HOME:/app --workdir /app -p 8787:80 -e REDIRECT_URL=http://localhost:8787 cyversevice/rstudio-verse:3.6.3
```
